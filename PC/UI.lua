...
function library:Window(options, ...)
	...
	if windowName and #windowName > 0 and library.WorkspaceName == "Jerry Hub" then
		library.WorkspaceName = convertfilename(windowName, "Jerry Hub")
	end
	...
	function windowFunctions:Tab(options, ...)
		...
		function tabFunctions:Section(options, ...)
			...
			sectionFunctions.CreateLabel = sectionFunctions.Label
			...
			sectionFunctions.CreateSlider = sectionFunctions.Slider
